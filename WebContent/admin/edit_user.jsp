...
<body>
	...
	<div class="login-main">
		<div class="form-container shadow">
			...
			<sql:query dataSource="${snapshot}" var="result"> SELECT * FROM USERS WHERE USERS_ID=<%=request.getParameter("id")%>; </sql:query>
			...
			<form class="login-form" action="../EditUser" method="post">
					...
					<c:if test="${result.rows[0].IS_ACTIVE}">
						<div class="padded-bottom">
							<input class="cb" type="checkbox" id="active_cb" name="active_cb" onchange="checkBoxUpdate(this)" checked> 
							<label for="active_cb">Active</label> 
							<input class="cb" type="checkbox" id="inactive_cb" name="inactive_cb" onchange="checkBoxUpdate(this)">
					...
					<c:if test="${!result.rows[0].IS_ACTIVE}">
						<div class="padded-bottom">
							<input class="cb" type="checkbox" id="active_cb" name="active_cb" onchange="checkBoxUpdate(this)"> 
							<label for="active_cb">Active</label> 
							<input class="cb" type="checkbox" id="inactive_cb" name="inactive_cb" onchange="checkBoxUpdate(this)" checked>
							<label for="inactive_cb">Inactive</label>
						</div>
					</c:if>
			
					<div class="padded-bottom"><input id="submit" type="submit" value="UPDATE"></div>
