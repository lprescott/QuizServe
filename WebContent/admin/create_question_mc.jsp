			...
			<div class="form-container-question">
				<form class="login-form" action="../CreateQuestion" method="post">
					...
					<input class="q_input_text" id="q_category" name="q_category"
						...
						placeholder="Answer #1" required> <input
						class="q_input_text" id="q_a2" name="q_a2" type="text"
						placeholder="Answer #2" required> <input
						class="q_input_text" id="q_a3" name="q_a3" type="text"
						placeholder="Answer #3" required> <input
						class="q_input_text" id="q_a4" name="q_a4" type="text"
						placeholder="Answer #4" required> <input
						class="q_input_text" id="q_a5" name="q_a5" type="text"
						placeholder="Answer #5"> <input class="q_input_text"
						id="q_a6" name="q_a6" type="text" placeholder="Answer #6">
